          ...
          children: [
            ...
            Form(
              ...
              child: Column(
                children: [
                  AppTextField(
                    controller: controller.loginUserNameTextEditingController,
                    hinText: AppString.loginPageStringHintTextForUsername,
                  ),
                  AppTextField(
                    controller: controller.loginPasswordTextEditingController,
                    hinText: AppString.loginPageStringHintTextForPassword,
                  ...
                  CustomSolidButton(
                      ...
                      onTap: () {
                        // Get.to(() => DailyLoginPageView());
                        controller.getStartLogin(
                            userName: controller
            ...
            RichText(
                ...
                text: TextSpan(
                    style: GoogleFonts.urbanist(
                        ...
                        color: AppColors.darkBlackishTextColor),
                    children: [
                      const TextSpan(
                          text: AppString.loginPageStringHaveAnAccount),
                      TextSpan(
                          recognizer: TapGestureRecognizer()
                            ..onTap = () {
                              Get.to(() => const RegisterView());
                            },
                          text: AppString.loginPageStringRegisterNow,
                          style: GoogleFonts.urbanist(
                              fontSize: 15,
                              fontWeight: FontWeight.w500,
